...
list_balls = ['B', 'H', 'I',
              'N', 'P', 'V']
list_strikes = ['B', 'C', 'F', 'K', 'L', 'M',
                'O', 'Q', 'R', 'S', 'T', 'X', 'Y']

fip_constant = {'YEAR_ID': [2018, 2017, 2016, 2015, 2014, 2013, 2012, 2011,
                            2010, 2009, 2008, 2007, 2006, 2005, 2004, 2003,
                            2002, 2001, 2000],
                'cFIP': [3.107, 3.158, 3.147, 3.134, 3.132, 3.048, 3.095,
...
group_cum = few_col.groupby([
        'YEAR_ID', 'PIT_ID', 'INN_CT'
...
pitch_counts = (
        few_col.groupby(['YEAR_ID', 'PIT_ID', 'INN_CT'])
...
merged['CUM_GB_PA'] = (
        (merged['CUM_GB_SUM'] - merged['CUM_FB_SUM'] - merged['CUM_PU_SUM']) /
        merged['CUM_PA_CT']
        )
...
merged['CUM_FIP'] = (((
        13*merged['CUM_HR_CT'] +
        3*(merged['CUM_BB_SUM'] + merged['CUM_HP_SUM']) -
        2*merged['CUM_SO_CT']) /
        merged['CUM_IP']) + merged_FIP['cFIP']
          )
